$srcs = ".\src\helm.c", ".\src\helm_cache.c", ".\src\helm_app.c", ".\src\helm_vd.c", ".\src\helm_sz.c", ".\src\helm_swap.c", ".\src\helm_max_min.c", ".\src\helm_uri.c", ".\src\helm_paste.c", ".\src\helm_mon.c", ".\src\helm_log.c"
